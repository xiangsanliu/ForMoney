...
public class FileDownloadTool {
    ...
    private static FileDownloadTool instance;

    private FileDownloadTool(Context context) {
        downloadManager = (DownloadManager) context.getSystemService(Context.DOWNLOAD_SERVICE);
        this.context = context.getApplicationContext();
    }

    public static FileDownloadTool getInstance(Context context) {
        if (instance == null) {
            instance = new FileDownloadTool(context);
        }
        return instance;
    }
    /**
     ...
     * @return file path
     * @see FileDownloadTool#getDownloadUri(long)
     */
     ...
     * @param downloadId an ID for the download, unique across the system.
     *                   This ID is used to make future calls related to this download.
     * @see FileDownloadTool#getDownloadPath(long)
     */
